...
### Other ideas
- ❓ store the forecast on `localStorage`
...
- - ❓ maybe animate the clouds and weather effects and set the sun height depending on the data from the forecast
- ❓ a paragraph describing the forecast
...
- - parameters: location, forecast as object, expiration date
...
- - ❌ search bar element
- - ❌ current forecast elements for icons and text
- - ❌ current forecast elements updater
